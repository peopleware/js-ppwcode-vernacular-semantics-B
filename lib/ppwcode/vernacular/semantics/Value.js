...
define(["dojo/_base/declare",
  ...
  "module"],
  function (declare, lang, js, module) {
    ...
    var Value = declare([], {
      ...
      _c_prop: function (subject, propName) {
        ...
        return js.getAllKeys(s).some(function (k) {
          return k === pName;
        });
      },
      ...
      constructor: function (/*Object*/ props) {
        this._c_pre(function () {
          return props /* exists and not null */;
        });
        this._c_pre(function () {
          return js.typeOf(props) === "object";
        });
      ...
      compare: function (/*Value*/ other) {
        ...
        //   public extension
        this._c_pre(function () {
          return !other || (other.isInstanceOf && other.isInstanceOf(this.constructor));
        });
