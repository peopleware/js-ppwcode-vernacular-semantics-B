...
define(["dojo/_base/declare", "./ValueMethodTests", "../_util/contracts/doh", "../EnumerationValue"],
       function(declare, ValueMethodTests, doh, EnumerationValue) {

         return declare([ValueMethodTests], {
